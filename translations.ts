...
export const translations: Record<Language, any> = {
  en: {
    ...
    pricing: {
      ...
      p_tags: '-',
      p_ai_tags: '-',
      p_daily_pro: 'Unlimited daily entries',
      p_history_pro: 'Full history access',
      p_report_pro: 'Report generation',
      p_tags_pro: 'Custom tag management',
      p_ai_tags_pro: 'AI auto-generate tags',
      price_free: 'Free',
      price_monthly: '¥9.99 / month',
      price_yearly: '¥79.99 / year',
      plan_monthly: 'Monthly',
      plan_yearly: 'Yearly',
      save_tag: 'Save 33%',
      billed_annually: 'Best value, billed annually',
      cancel_anytime: 'Pay monthly, cancel anytime',
      cta_free: 'Download Free',
      cta_pro: 'Subscribe',
      trial_text: '1 week free trial',
  ...
  zh: {
    ...
    pricing: {
      ...
      p_ai_tags: '-',
      p_daily_pro: '无限每日记录',
      p_history_pro: '访问全部历史',
      p_report_pro: '生成分析报告',
      p_tags_pro: '自定义标签管理',
      p_ai_tags_pro: 'AI 自动生成标签',
      price_free: '免费',
      price_monthly: '¥9.99 / 月',
      price_yearly: '¥79.99 / 年',
      plan_monthly: '月度订阅',
      plan_yearly: '年度订阅',
      save_tag: '省 33%',
      billed_annually: '超值，按年计费',
      cancel_anytime: '按月支付，随时取消',
      cta_free: '免费下载',
      cta_pro: '订阅',
      trial_text: '1 周免费试用',
      restore: '恢复购买'
